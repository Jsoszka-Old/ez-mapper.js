...
So what can we do instead? We would advise creating a mapping method in your objects that need them and using ez-mapper there like such. In our opinion this is better than maintaining a configuration file because it keeps the logic close to the objects themselves.
